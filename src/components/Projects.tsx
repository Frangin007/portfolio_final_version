        ...
        <div style={{
          ...
          {projects.map((p, i) => (
            <div key={i} className="g-card" style={{
              ...
              boxShadow: hov === i ? `0 20px 50px rgba(0,0,0,0.4), 0 0 24px ${p.color}14` : 'none',
            ...
            onMouseLeave={() => setHov(null)}>
              ...
              <div style={{ position: 'relative', overflow: 'hidden', height: '180px' }}>
                <img src={p.img} alt={p.title} style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.5s ease', transform: hov === i ? 'scale(1.07)' : 'scale(1)', filter: 'brightness(0.55)' }} />
                {/* année en filigrane */}
